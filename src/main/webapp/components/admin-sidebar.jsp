...
<aside class="sidebar">
    ...
    <ul class="sidebar-nav">
        <li>
            <a href="AdminDashboard.jsp" class="<%= requestURI.contains("AdminDashboard") ? "active" : "" %>">
                <span class="nav-icon">
        ...
        <li>
            <a href="CitizenList.jsp" class="<%= requestURI.contains("CitizenList") ? "active" : "" %>">
                <span class="nav-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <li>
            <a href="DocumentList.jsp" class="<%= requestURI.contains("DocumentList") ? "active" : "" %>">
                <span class="nav-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
    ...
    <ul class="sidebar-nav">
        <li>
            <a href="NewsList.jsp" class="<%= requestURI.contains("NewsList") ? "active" : "" %>">
                <span class="nav-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <li>
            <a href="JobList.jsp" class="<%= requestURI.contains("JobList") ? "active" : "" %>">
                <span class="nav-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <li>
            <a href="PollManagement.jsp" class="<%= requestURI.contains("PollManagement") ? "active" : "" %>">
                <span class="nav-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <li>
            <a href="ApplicationList.jsp" class="<%= requestURI.contains("ApplicationList") ? "active" : "" %>">
                <span class="nav-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
    ...
    <ul class="sidebar-nav">
        <li>
            <a href="ReportIssue.jsp" class="<%= requestURI.contains("ReportIssue") ? "active" : "" %>">
                <span class="nav-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <li>
            <a href="NoticeList.jsp" class="<%= requestURI.contains("NoticeList") ? "active" : "" %>">
                <span class="nav-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <li>
            <a href="IssueFine.jsp" class="<%= requestURI.contains("IssueFine") ? "active" : "" %>">
                <span class="nav-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
