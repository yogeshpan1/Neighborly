...
<body>
	...
	<div class="main">
		...
		<section class="manage-listings">
			...
			<div
				style="border-bottom: 1px solid #323639; margin-top: 20px; margin-bottom: 24px;"></div>

			<div class="list-card">
				<div class="list-info">
					<h4>
						Electrician <span class="status">Active</span>
					</h4>
					<div class="listing-meta">
						<span>TECHNICAL SERVICES</span> <span>Posted Oct 12, 2025</span>
					</div>
				</div>
			...
			<div class="list-card">
				<div class="listS-info">
					<h4>
						Junior Data Analyst <span class="status">Active</span>
					</h4>
					<div class="listing-meta">
						<span>IT SERVICES</span> <span>Posted Sep 28, 2025</span>
					</div>
				</div>
				<div class="list-actions">
					<button class="edit">Edit</button>
			...
			<div class="list-card">
				<div class="list-info">
					<h4>
						Health Nurse <span class="status">Active</span>
					</h4>
					<div class="listing-meta">
						<span>HEALTH SERVICES</span> <span>Posted Oct 05, 2025</span>
					</div>
				</div>
				<div class="list-actions">
					<button class="edit">Edit</button>
