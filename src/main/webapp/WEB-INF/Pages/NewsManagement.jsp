		...
		<div class="modalBox"
			...
			<form action="<%=request.getContextPath()%>/editNews" method="POST">
				...
				<div class="modalBodyContent">
					<div class="newsFormGroup">
						<label class="newsFormLabel">Title</label> <input type="text"
							class="newsFormInput" id="editNewsTitleInput" name="newsTitle"
							required>
					</div>
					<div class="newsFormGroup">
						<label class="newsFormLabel">Description</label>
						<textarea class="newsFormTextarea" id="editNewsDescriptionInput"
							name="newsDescription" required></textarea>
					</div>
				</div>
				<div class="modalFooterActions">
					<button type="button" class="buttonModalCancel"
			...
			<form action="<%=request.getContextPath()%>/deleteNews" method="POST">
				...
				<div class="modalBodyContent">
					<p class="modalDescriptionText">
						You are about to permanently delete <strong id="deleteNewsName"
							style="color: #ffffff; font-weight: 700;">News Title</strong>.
					...
					<div class="newsFormGroup">
						...
						<textarea class="newsFormTextarea" name="deleteReason"
							...
							style="min-height: 90px;" required></textarea>
					</div>
				</div>
				<div class="modalFooterActions">
					<button type="button" class="buttonModalCancel"
