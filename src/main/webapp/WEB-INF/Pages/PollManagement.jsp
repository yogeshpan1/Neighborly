        ...
        <div class="pollPageWrapper">
            ...
            <div class="pollsStatContainer">
                ...
                <div class="statCardPoll">
                    ...
                    <div class="statInfo">
                        <span class="statLabel">Total Votes</span>
        ...
        <form action="<%= request.getContextPath() %>/deletepoll" method="POST">
            ...
            <div class="modalBody" style="padding: 24px 28px;">
                <p style="color: #CFD3D6; font-size: 14px; margin-top: 0; margin-bottom: 24px; line-height: 1.5;">
                    You are about to permanently delete the poll. 
                ...
                <div class="formGroup">
                    ...
                    <textarea class="formInput" name="deletionReason" placeholder="Provide a detailed explanation for this deletion context." required style="min-height: 110px;"></textarea>
                </div>
            </div>
