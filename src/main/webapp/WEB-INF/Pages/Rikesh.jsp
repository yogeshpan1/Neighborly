    ...
    <main class="portfolioContainer">
        ...
        <div class="mainLayout">
            ...
            <aside class="sidebar">
                ...
                <div class="avatarBox">
                    <img src="${pageContext.request.contextPath}/Images/Rikesh.jpeg" alt="Rikesh Adhikari" class="avatarImg">
                </div>
                ...
                <article id="resumeTab" class="articlePage">
                    <div class="cvDownloadSection">
                        <div class="cvDownloadBox">
                            ...
                            <a href="${pageContext.request.contextPath}/assets/cv/rikesh.pdf" class="cvDownloadBtn" download>
                                Download CV
                            </a>
                        </div>
                    </div>
